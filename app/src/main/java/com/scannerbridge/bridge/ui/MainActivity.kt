...
class MainActivity : AppCompatActivity(),
    ...
    private fun attachCameraFragment() {
        ...
        val frag = CameraBridgeFragment.newInstance().apply { callbacks = this@MainActivity }
        cameraFragment = frag
